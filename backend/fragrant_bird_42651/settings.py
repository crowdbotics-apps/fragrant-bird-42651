"""
Django settings for fragrant_bird_42651 project.
...
ROOT_URLCONF = 'fragrant_bird_42651.urls'
...
WSGI_APPLICATION = 'fragrant_bird_42651.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fragrant_bird_42651 API",
    "DESCRIPTION": "API documentation for fragrant_bird_42651 App",
    "VERSION": "v1",
}
